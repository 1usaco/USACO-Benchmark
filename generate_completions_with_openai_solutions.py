...
# If you are using Hints.openai, make sure to change `solutions.json` to `openai_solutions.json` (if you are using the paper's provided generated solutions.
# If you are bringing your own, make sure it conforms to {str<problem_id>: str<solution_text>}
